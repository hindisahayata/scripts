<?php if($_GET["n"]) $from = str_replace("-"," ",$_GET["n"]); else $from = ''; $link = "https://".$_SERVER['HTTP_HOST'].'/?n='.$from; $link = str_replace(" ","-",$link); ?>
<html>
<head>

<meta http-equiv=21"Content-Type" content="text/html; charset=utf-8">
<meta name="google" content="notranslate" />
<meta http-equiv="X-UA-Compatible" content="IE=codester">
<meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" name="viewport" />
<meta name="keywords" content="touch karo aur jadu dekho, जादुई दिल को टच करके देखो happy new year, hindisahayata , जादुई दिल को टच करके देखो happy new year 2024, touch karo jadu dekho, जादुई दिल को टच करके देखो,jadu dekho.in,jadu dekho in, wishing website, wishing website tool,इस दिल को टच करके देखो, इस अशोक चक्र को टच करके देखो, click it me, click it in, click-it.me, jadu dekho live, click karo in, click 2 open, wishing script, whatsapp viral website, wishes, greeting wishes, web greeting, web greeting with name, wish with name,इस जादुई दिल दिल को टच करके देखो,">
<meta property="og:type" content="website" />
<meta property="og:title" content="।। गणतंत्र दिवस की शुभकामनायें ।।" />
<meta property="og:description" content="।। गणतंत्र दिवस की शुभकामनायें ।।" />
<meta property="og:site_name" content="।। गणतंत्र दिवस की शुभकामनायें ।।" />
<title>।। गणतंत्र दिवस की शुभकामनायें ।।</title>
<link rel="stylesheet" href="animate.min.css">
<link rel="icon" type="image/png" sizes="32x32" href="https://bit.ly/fhindisahayata">
<style>
...
<br>
<div style="font-size: 25px;text-shadow: 1px 1px 3px blue, 1px 1px 3px blue, -1px -1px 3px blue, -1px -1px 3px black;color:white;font-weight: bold;"><br><b>इस अशोक चक्र को <br> टच करके देखो !<br>👇👇👇</b></div><br>

<div class="animated pulse" style="background-size: 58%; background-position: center; background-repeat: no-repeat;">
<img id="loading" src="img/root.png?v=1448231414" class="center swing1" style="max-width:143px; width: 100%;" />
</div>
      </a>
      <div class="leftcurtain"><img src="img/parda1.jpg"/></div>
      <div class="rightcurtain"><img src="img/parda1.jpg"/></div>
<marquee class="m1" behavior="scroll" direction="up" scrolldelay="0"> <br>
<img src="img/1.png?v=778866" height="30px" width="30px"/><br><br>
<img src="img/2.png?v=778866" height="30px" width="30px"/><br><br>
<img src="img/3.png?v=778866" height="30px" width="30px"/><br><br>
<img src="img/4.png?v=778866" height="30px" width="30px"/><br><br>
<img src="img/1.png?v=778866" height="30px" width="30px"/><br><br>
<img src="img/2.png?v=778866" height="30px" width="30px"/><br><br>
<img src="img/3.png?v=778866" height="30px" width="30px"/><br><br>
<img src="img/4.png?v=778866" height="30px" width="30px"/><br><br>
...
<div style="font-size: 10px; font-weight: 550; color: black;">
 ...
 <img src="img/main.png" width="80%" style="animation: pulse 2.5s infinite"><br>
 <br>
 <img src="img/main2.png" width="80%" style="animation: pulse 4s infinite"><br>
 <br>
 <img src="img/mahan.gif" width="75%" style="animation: pulse 2s infinite"><br>
...
<p style="color:purple"><b>!! गणतंत्र दिवस की शुभकामनायें !!</b></p>
</div>
<br>  
